...
```
```
cmake-prebuild co 2021-11-08 https://github.com/kuyoonjo/co.git master openssl/1.1.1l,zlib-ng/2.0.5,libssh2/1.10.0,libcurl/7.79.1 "-DWITH_LIBCURL=ON -DWITH_OPENSSL=ON -DSTATIC_VS_CRT=ON"
```